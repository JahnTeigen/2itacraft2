...
import net.mcreator.itacraft.procedures.DeportableOnEffectActiveTickProcedure;
...
@EventBusSubscriber
public class DeportableMobEffect extends MobEffect {
	public DeportableMobEffect() {
		super(MobEffectCategory.HARMFUL, -1, mobEffectInstance -> (SimpleParticleType) (ItacraftModParticleTypes.RUSSIA_PARTICLE.get()));
	...
	public boolean applyEffectTick(ServerLevel level, LivingEntity entity, int amplifier) {
		DeportableOnEffectActiveTickProcedure.execute(level, entity.getX(), entity.getY(), entity.getZ());
	...
	public static void modifyItemComponents(ModifyDefaultComponentsEvent event) {
		...
		if (original != null) {
			...
			onConsumeEffects.add(new RemoveStatusEffectsConsumeEffect(ItacraftModMobEffects.DEPORTABLE));
