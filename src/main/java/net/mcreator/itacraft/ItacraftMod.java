...
import net.mcreator.itacraft.init.*;
...
@Mod("itacraft")
public class ItacraftMod {
	public static final Logger LOGGER = LogManager.getLogger(ItacraftMod.class);
	public static final String MODID = "itacraft";

	public ItacraftMod(IEventBus modEventBus) {
