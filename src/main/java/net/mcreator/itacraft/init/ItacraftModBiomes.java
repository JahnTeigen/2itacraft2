...
@EventBusSubscriber
public class ItacraftModBiomes {
	@SubscribeEvent
		...
		for (LevelStem levelStem : levelStemTypeRegistry.stream().toList()) {
			...
			if (dimensionType.is(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					((ItacraftModNoiseGeneratorSettings) (Object) noiseGenerator.settings.value()).setitacraftDimensionTypeReference(dimensionType);
				}
			}
		}
	}
	...
	public interface ItacraftModNoiseGeneratorSettings {
		void setitacraftDimensionTypeReference(Holder<DimensionType> dimensionType);
	}
}