...
public class ModelTonyHaynes extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("itacraft", "model_tony_haynes"), "main");
	...
	public final ModelPart Paynes;

	public ModelTonyHaynes(ModelPart root) {
		super(root);
		...
		this.Paynes = root.getChild("Paynes");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				...
				PartPose.offset(1.9F, 12.0F, 0.0F));
		PartDefinition Paynes = partdefinition.addOrReplaceChild("Paynes",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-4.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 4)
						.addBox(-3.0F, -1.0F, -2.0F, 3.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 2).addBox(-3.0F, 5.0F, -2.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
	...
	public void setupAnim(LivingEntityRenderState state) {
		...
		this.Paynes.yRot = netHeadYaw / (180F / (float) Math.PI);
		this.Paynes.xRot = headPitch / (180F / (float) Math.PI);
	}
}