...
public class ModelTonyHaynes<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart Paynes;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Paynes = partdefinition.addOrReplaceChild("Paynes",
				CubeListBuilder.create().texOffs(0, 0)
						...
						.addBox(-4.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 4)
						.addBox(-3.0F, -1.0F, -2.0F, 3.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 2)
						.addBox(-3.0F, 5.0F, -2.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,
		...
		Paynes.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
